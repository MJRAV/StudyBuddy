    ...
    <div className="flex min-h-screen items-center justify-center p-4 bg-amber-50">
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader className="text-center space-y-4 pb-6 pt-8">
          ...
          <CardDescription className="text-base">Join our mentorship community</CardDescription>
        </CardHeader>
        <CardContent className="px-6 pb-8">
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <div className="relative my-6">
              <Separator />
              <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-white px-4 text-sm text-zinc-500">
                Or continue with
              </span>
            </div>
