export type Major = 'BSIT' | 'BSCS' | 'BSIS';
export type Year = '1' | '2' | '3' | '4';
export type Semester = '1' | '2';

export const coursesByMajor: Record<Major, Record<Year, Record<Semester, string[]>>> = {
  BSIT: {
    '1': {
...
export function getCoursesFromCatalog(major: Major, year: Year, semester: Semester): string[] {
